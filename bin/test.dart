...
void main() {
  ...
  RawDatagramSocket.bind(InternetAddress("192.168.19.120"), 5080)
      .then((RawDatagramSocket socket) {
    print('UDP Echo ready to receive');
    print('${socket.address.address}:${socket.port}');

    _handler = ReqHandler("192.168.19.120", 5080, socket);
    ...
    socket.listen((RawSocketEvent e) {
      ...
      onNewMessage(String data, sockaddr_in src) {
        // print(data);
        dynamic msg = _messagesFactory.createMessage(data, src) as dynamic;
